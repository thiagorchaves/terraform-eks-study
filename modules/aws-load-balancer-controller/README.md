...
| [aws_iam_role_policy_attachment.eks-role-controller-role-attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_oidc_url"></a> [oidc\_url](#input\_oidc\_url) | HTTPS URL from OIDC provider of the EKS cluster | `string` | n/a | yes |
